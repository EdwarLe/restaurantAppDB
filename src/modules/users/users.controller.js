...
export const updateUser = catchAsync(async(req, res, next) => {
    const {user} = req
    const {hasError, errorMessage, registerData} = validatePartialUser(req.body)
    ...
    const userUpdated = await userService.updateUser(user, registerData.name, registerData.email)
